# -*- coding: utf-8 -*-
"""
Created on Mon Nov 27 16:23:51 2017
...
for m in range(1,13):
    ...
    if feature.empty:
        ...
        card.to_csv('f:/prize/PrizePredict/data/input/time/featureM%d.csv'%m,index=True)
...
if feature.empty:
    ...
    card.to_csv('f:/prize/PrizePredict/data/input/time/featureH7-.csv',index=True)
...
if feature.empty:
    ...
    card.to_csv('f:/prize/PrizePredict/data/input/time/featureH%d.csv'%h,index=True)
...
if feature.empty:
    ...
    card.to_csv('f:/prize/PrizePredict/data/input/time/featureH19+.csv',index=True)
...
if feature.empty:
    ...
    card.to_csv('f:/prize/PrizePredict/data/input/time/featureWD.csv',index=True)
...
if feature.empty:
    ...
    card.to_csv('f:/prize/PrizePredict/data/input/time/featureWE.csv',index=True)
