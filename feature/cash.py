...
college.to_csv('f:/prize/PrizePredict/data/input/college.csv',index=True)
...
card.to_csv('f:/prize/PrizePredict/data/input/card_bashfeature.csv',index=True)
card = pd.read_csv('f:/prize/PrizePredict/data/input/card_bashfeature.csv') 
...
del consume
card_consume.to_csv('f:/prize/PrizePredict/data/input/card_consumefeature.csv',index=True)
card_consume = pd.read_csv('f:/prize/PrizePredict/data/input/card_consumefeature.csv') 
...
del kapiankaihu
card_kaihu.to_csv('f:/prize/PrizePredict/data/input/card_kaihufeature.csv',index=True)
card_kaihu = pd.read_csv('f:/prize/PrizePredict/data/input/card_kaihufeature.csv') 
...
del kapianxiaohu
card_xiaohu.to_csv('f:/prize/PrizePredict/data/input/card_xiaohufeature.csv',index=True)
card_xiaohu = pd.read_csv('f:/prize/PrizePredict/data/input/card_xiaohufeature.csv') 
...
del kapianbuban
card_buban.to_csv('f:/prize/PrizePredict/data/input/card_bubanfeature.csv',index=True)
card_buban = pd.read_csv('f:/prize/PrizePredict/data/input/card_bubanfeature.csv') 
...
del kapianjiegua
card_jiegua.to_csv('f:/prize/PrizePredict/data/input/card_jieguafeature.csv',index=True)
card_jiegua = pd.read_csv('f:/prize/PrizePredict/data/input/card_jieguafeature.csv') 
...
del kapianchange
card_change.to_csv('f:/prize/PrizePredict/data/input/card_changefeature.csv',index=True)
card_change = pd.read_csv('f:/prize/PrizePredict/data/input/card_changefeature.csv') 
card_change=card_change.rename(columns={'pos' : 'change_count'}) 

train_test = pd.merge(train_test, card_change, how='left',on='id') 
del card_change
#%%
## 此模块生在食堂 开水房  等地方的消费次数 均值 最大值等信息
...
del canteen
card_canteen.to_csv('f:/prize/PrizePredict/data/input/card_canteenfeature.csv',index=True)
card_canteen = pd.read_csv('f:/prize/PrizePredict/data/input/card_canteenfeature.csv') 
...
del boiled_water
card_boiled_water.to_csv('f:/prize/PrizePredict/data/input/card_boiled_waterfeature.csv',index=True)
card_boiled_water = pd.read_csv('f:/prize/PrizePredict/data/input/card_boiled_waterfeature.csv') 
...
del bathe
card_bathe.to_csv('f:/prize/PrizePredict/data/input/card_bathefeature.csv',index=True)
card_bathe = pd.read_csv('f:/prize/PrizePredict/data/input/card_bathefeature.csv') 
...
del shool_bus
card_shool_bus.to_csv('f:/prize/PrizePredict/data/input/card_shool_busfeature.csv',index=True)
card_shool_bus = pd.read_csv('f:/prize/PrizePredict/data/input/card_shool_busfeature.csv') 
...
del shop
card_shop.to_csv('f:/prize/PrizePredict/data/input/card_shopfeature.csv',index=True)
card_shop = pd.read_csv('f:/prize/PrizePredict/data/input/card_shopfeature.csv') 
...
del wash_house
card_wash_house.to_csv('f:/prize/PrizePredict/data/input/card_wash_housefeature.csv',index=True)
card_wash_house = pd.read_csv('f:/prize/PrizePredict/data/input/card_wash_housefeature.csv') 
...
del library
card_library.to_csv('f:/prize/PrizePredict/data/input/card_libraryfeature.csv',index=True)
card_library = pd.read_csv('f:/prize/PrizePredict/data/input/card_libraryfeature.csv') 
...
del printhouse
card_printhouse.to_csv('f:/prize/PrizePredict/data/input/card_printhousefeature.csv',index=True)
card_printhouse = pd.read_csv('f:/prize/PrizePredict/data/input/card_printhousefeature.csv') 
...
del dean
card_dean.to_csv('f:/prize/PrizePredict/data/input/card_deanfeature.csv',index=True)
card_dean = pd.read_csv('f:/prize/PrizePredict/data/input/card_deanfeature.csv') 
...
del other
card_other.to_csv('f:/prize/PrizePredict/data/input/card_otherfeature.csv',index=True)
card_other = pd.read_csv('f:/prize/PrizePredict/data/input/card_otherfeature.csv') 
...
del hospital
card_hospital.to_csv('f:/prize/PrizePredict/data/input/card_hospitalfeature.csv',index=True)
card_hospital = pd.read_csv('f:/prize/PrizePredict/data/input/card_hospitalfeature.csv') 
